...
_Imprinting and Merging surfaces accelerates the DAGMC process by combining surfaces and simplifying the process so that no area in space can be owned by more than one volume. The default tolerance for distance between surfaces is 5.0e-4._
